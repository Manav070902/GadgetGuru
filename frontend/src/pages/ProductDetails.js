      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        {loading ? (
          <div className="grid gap-1 w-full">
            ...
            <h2 className="text-2xl lg:text-4xl font-medium h-6 lg:h-8 bg-slate-200 animate-pulse w-full"><div></div></h2>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 my-2">
              <button
                className="border-2 border-blue-600 rounded px-3 py-1 min-w-[120px] text-blue-600 font-medium hover:bg-blue-600 hover:text-white transition"
                onClick={(e) => handleBuyProduct(e, data?._id)}
              >
                Buy
              </button>
              <button
                className="border-2 border-blue-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-blue-600 hover:text-blue-600 hover:bg-white transition"
